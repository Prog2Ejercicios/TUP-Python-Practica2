...
def numeros_al_final_basico(lista: List[Union[float, str]]) -> List[Union[float, str]]:  # noqa: E501
    ...
    for elemento in lista:
        if type(elemento)==str:
            nueva_lista_str.append(elemento)
        if type(elemento)==int:
            nueva_lista_int.append(elemento)
    return nueva_lista_str + nueva_lista_int
...
def numeros_al_final_comprension(lista: List[Union[float, str]]) -> List[Union[float, str]]:  # noqa: E501
    ...
    """
    numeros = filter(lambda x: type(x)==int, lista)
    strings = filter(lambda x: type(x)==str, lista)

    return list(strings) + list(numeros)
